...
// ─────────────────────────────────────────────
// Site Settings (logo, tagline vb.)
// ─────────────────────────────────────────────

export interface SiteSettings {
  logoUrl?: string;          // Yüklenen logonun data URI'si (base64) ya da URL'i
  logoUrlDark?: string;      // Koyu zeminler için ayrı logo (opsiyonel)
  brandName?: string;        // Override edebilir; boşsa "Aslan Marin"
  tagline?: string;          // Logo altında küçük yazı; boşsa "Yat Döşeme · Est. 2007"
  updatedAt?: number;
}
