        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-7">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/"
              target="_blank"
              className="rounded-full border border-navy/15 px-4 py-2 text-xs font-semibold text-navy transition-colors hover:border-navy hover:bg-navy hover:text-white"
            >
              Siteyi Görüntüle
            </Link>
            <button
              onClick={logout}
              className="rounded-full bg-navy px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-navy-700"
            >
              Çıkış
            </button>
          </div>
